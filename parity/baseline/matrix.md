...
| `dsf offboard` | authoritative | command-behavior, exit-behavior, dry-run-plan | `evidence/commands/dsf-offboard-dry-run-missing-manifest.json`<br>`evidence/commands/dsf-parser-surface-snapshot.json` |
| `dsf delete/deprovision` | authoritative | command-behavior, exit-behavior, dry-run-plan | `evidence/commands/dsf-delete-missing-manifest.json`<br>`evidence/commands/dsf-parser-surface-snapshot.json` |
...
| `control-center GET /api/state` | authoritative | machine-readable-output, request-shape, persisted-record | `evidence/request-shapes/control-center-http-requests.json`<br>`evidence/persisted-records/control-center-state-record.json` |
