...
* :class:`WebIqMcpBackend` — live mode. Derives industry/competitive research
  ...
  :func:`dsf.agents.webiq.client.build_webiq_client_from_env` — the Microsoft
  WebIQ SDK by default; Tavily optional.

Live-mode contract:
    ``search`` is a web search/fetch client (the Microsoft WebIQ SDK by
