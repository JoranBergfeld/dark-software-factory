# FoundryIQ source agent — Python parity reference (frozen)

This package is the pre-cutover Python implementation of the FoundryIQ
source agent. It is kept only as a **parity reference** for the #149 cutover
...
parity implementation of this source agent (Azure AI Search knowledge-chunk
